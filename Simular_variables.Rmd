...
En el siguiente guía se simulan diversos set de datos y figuras con el propósito de ser utilizados en la enseñanza la Bioestadistica aplicada a la acuicultura. 

**Índice**
1. [Distribución media muestral: caso 1](#id1)
2. [Distribución media muestral: caso 2](#id2)
3. [Correlación entre dos variables: N = 50.000](#id3)
4. [ANOVA 1 vía: Peso ~  cepas (Tilapia)](#id4)
...
8. [Regresión lineal múltiple: 2 variables predictoras con multicolinealidad](#id8)
...
<div id='id8' />
## Regresión lineal múltiple: ejercicio clase.
